...
```
LDAPTLS_REQCERT=never ldapsearch -LLL -H ldaps://ldap.kubo2.mbp -D "cn=admin,dc=odp,dc=com" -w admin123 -x -bou=Users,dc=odp,dc=com uid=sergea
LDAPTLS_CACERT=/Users/sa/dev/d3/git/odp_certificates/CA/ca.crt ldapsearch -LLL -H ldaps://ldap.kubo2.mbp -D "cn=admin,dc=odp,dc=com" -w admin123 -x -bou=Users,dc=odp,dc=com uid=sergea
```
